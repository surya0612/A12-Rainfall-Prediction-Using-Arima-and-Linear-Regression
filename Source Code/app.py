    ...
    if request.method == 'POST':
        ...
        if method == 'regression' :
            ...
            for predictfeature in feature_to_predict:
                ...
                print('The Explained Variance: %.1f' % regressor.score(X_test, y_test))
                print('The Mean Absolute Error: %.1f degrees celcius' % mean_absolute_error(
                    y_test, prediction))
                print('The Median Absolute Error: %.1f degrees celcius' %
